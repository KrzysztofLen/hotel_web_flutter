...
import 'package:web_burger/controllers/house_controller.dart';

class PageScreen extends StatefulWidget {
  final String title;

  PageScreen({this.title, Key key}) : super(key: key);

  @override
  PageState createState() => PageState();
}

class PageState extends State<PageScreen> with SingleTickerProviderStateMixin {
